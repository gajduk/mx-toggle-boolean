...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            distDeployment: {
                files: [ {
                    dest: "./dist/RefreshViewHelper/deployment/web/widgets",
                    cwd: "./dist/tmp/src/",
                    src: [ "**/*" ],
                    expand: true
                } ]
            ...
            mpk: {
                files: [ {
                    dest: "./dist/RefreshViewHelper/widgets",
        ...
        clean: {
            build: [
                ...
                "./dist/tsc/**/*",
                "./dist/testresults/**/*",
                "./dist/RefreshViewHelper/deployment/web/widgets/" + pkg.widgetName + "/*",
                "./dist/RefreshViewHelper/widgets/" + pkg.widgetName + ".mpk"
            ]
        },
