...
public class Container
{
	...
	{
		java.util.List<myfirstmodule.proxies.Container> result = new java.util.ArrayList<myfirstmodule.proxies.Container>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//MyFirstModule.Container" + xpathConstraint))
			result.add(myfirstmodule.proxies.Container.initialize(context, obj));
		return result;
	}
